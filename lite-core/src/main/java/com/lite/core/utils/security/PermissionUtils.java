package com.lite.core.utils.security;
...
public class PermissionUtils
{
    ...
    public static String getMsg(String permissionsStr)
    {
		...
		/*
		 * String msg = MessageUtils.message(PERMISSION, permission); if
		 * (StringUtils.endsWithIgnoreCase(permission,
		 * PermissionConstants.ADD_PERMISSION)) { msg =
		 * MessageUtils.message(CREATE_PERMISSION, permission); } else if
		 * (StringUtils.endsWithIgnoreCase(permission,
		 * PermissionConstants.EDIT_PERMISSION)) { msg =
		 * MessageUtils.message(UPDATE_PERMISSION, permission); } else if
		 * (StringUtils.endsWithIgnoreCase(permission,
		 * PermissionConstants.REMOVE_PERMISSION)) { msg =
		 * MessageUtils.message(DELETE_PERMISSION, permission); } else if
		 * (StringUtils.endsWithIgnoreCase(permission,
		 * PermissionConstants.EXPORT_PERMISSION)) { msg =
		 * MessageUtils.message(EXPORT_PERMISSION, permission); } else if
		 * (StringUtils.endsWithAny(permission, new String[] {
